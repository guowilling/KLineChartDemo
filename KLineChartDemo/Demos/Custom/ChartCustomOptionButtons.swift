...
class OptionTimeButton: OptionBaseButton {
...
class OptionMenuButton: OptionBaseButton {
    
    var triangleColor: UIColor!
    
    weak var menuView: OptionMenuBaseView?
...
class OptionMenuMoreButton: UIButton {
...
class OptionMenuIndexButton: UIButton {
